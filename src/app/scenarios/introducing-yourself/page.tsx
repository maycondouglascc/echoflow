...
import { introducingYourselfScenario } from "@/lib/fixtures/introducing-yourself";
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mb-7 mt-12 sm:mb-9 sm:mt-16">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#668078]">
            Practice scenario · 01
          </p>
          <h1 className="mt-3 text-4xl font-semibold tracking-[-0.045em] sm:text-5xl">
            {introducingYourselfScenario.title}
          </h1>
          <p className="mt-3 max-w-2xl text-base leading-7 text-[#61776e]">
            {introducingYourselfScenario.description}
          </p>
        </section>

        <ShadowingPractice scenario={introducingYourselfScenario} />
